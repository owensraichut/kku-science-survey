...
/**
 * รหัสผ่านเข้าแดชบอร์ด — เปลี่ยนค่านี้ก่อนใช้งานจริง
 * หมายเหตุ: เป็นการตรวจสอบฝั่งหน้าเว็บ กันผู้ใช้ทั่วไปเปิดดูโดยบังเอิญเท่านั้น
 * ผู้ที่เปิดดูซอร์สโค้ดยังเห็นค่านี้ได้ จึงไม่ควรใช้รหัสเดียวกับระบบอื่น
 */
